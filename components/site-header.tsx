...
export function SiteHeader() {
  return (
    <header className="sticky top-0 z-50 border-b border-zinc-950/10 bg-fog/86 backdrop-blur-xl transition-colors duration-500 dark:border-lime-300/10 dark:bg-ink/86">
